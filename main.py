...
class SerialPlot:
    def __init__(self, serialPort='/dev/cu.usbserial-110', serialBaud=115200, plotLength=100, dataNumBytes=2):
        ...
        try:
            ...
            # cmd = input("Enter gen frequency") + '\r'
            # print(cmd)
            # self.serialConnection.write(cmd.encode())
        except:
    ...
    def getSerialData(self, frame, lines, lineValueText, lineLabel, timeText):
        ...
        self.data.append(value / 1024.0 * 5)  # we get the latest data point and append it to our array
